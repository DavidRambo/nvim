...
-- Windows
n_remap("<leader>wts", ":split<CR>:Telescope buffers<CR>")
n_remap("<leader>wtv", ":vsplit<CR>:Telescope buffers<CR>")
n_remap("<leader>ws", ":split<CR>")
n_remap("<leader>wv", ":vsplit<CR>")
n_remap("<leader>wh", "<C-w><Left>")
n_remap("<leader>we", "<C-w><Right>")
n_remap("<leader>wo", "<C-w><Up>")
n_remap("<leader>wa", "<C-w><Down>")
n_remap("<leader>wb", "<C-w>=")
n_remap("<leader>wm", ":only<CR>")
...
vim.keymap.set("n", "<leader>bb", require("telescope.builtin").buffers, { desc = "telescope buffers" })
